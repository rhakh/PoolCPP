...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/10/07 23:27:30 by apelykh           #+#    #+#             */
/*   Updated: 2018/10/07 23:27:31 by apelykh          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		Game::startGame() {
	...
	while ((this->pressCode = getch()) != 27) {
		...
		if (pl_height < player->getY() || pl_length < player->getX()) {
			player->setX(PL_START_X + 1);
			player->setY(pl_height / 2);
		}
